            ...
            <Fade {...TransitionProps} timeout={100}>
              <Paper className="ohm-menu" elevation={1}>
                ...
                <Box component="div" className="data-links">
                  ...
                  <Link href={`https://dune.xyz/shadow/`} target="_blank" rel="noreferrer">
                    <Button size="large" variant="contained" color="secondary" fullWidth>
                      <Typography align="left">
                    ...
                    <Box display="flex" flexDirection="row" justifyContent="space-between">
                      {OHM_ADDRESS && (
                        <Button
                          variant="contained"
                          color="secondary"
                          onClick={addTokenToWallet("MDAO", OHM_ADDRESS, address)}
                        >
                          <SvgIcon
                      ...
                      {SOHM_ADDRESS && (
                        <Button
                          variant="contained"
                          color="secondary"
                          onClick={addTokenToWallet("sMDAO", SOHM_ADDRESS, address)}
                        >
                          <SvgIcon
                      ...
                      {GOHM_ADDRESS && (
                        <Button
                          variant="contained"
                          color="secondary"
                          onClick={addTokenToWallet("gMDAO", GOHM_ADDRESS, address)}
                        >
                          <SvgIcon
                            ...
                            style={{ height: "25px", width: "25px" }}
                          />
                          <Typography variant="body1">gMDAO</Typography>
                        </Button>
                      )}
                      {PT_TOKEN_ADDRESS && (
                        <Button
                ...
                <Divider color="secondary" />
                <Link href="https://docs.mydao.io/using-the-website/unstaking_lp" target="_blank" rel="noreferrer">
                  <Button size="large" variant="contained" color="secondary" fullWidth>
                    <Typography align="left">
                ...
                <Link
                  href="https://synapseprotocol.com/?inputCurrency=gMDAO&outputCurrency=gMDAO&outputChain=43114"
                  target="_blank"
                  rel="noreferrer"
                >
                  <Button size="large" variant="contained" color="secondary" fullWidth>
